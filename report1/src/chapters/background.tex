...
Pictured in \labelindexref{Figure}{img:QEMU-in-stubdomain}, this hyper-specialised guest is known as a stubdomain (or stubdom) and is currently build as a MiniOS unikernel against an out-of-date QEMU version.
